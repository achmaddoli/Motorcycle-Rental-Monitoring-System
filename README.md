...
- **🔊 Smart Alarm System:** Built-in buzzer/speaker alert that triggers when the rental time is about to expire or when a violation is detected, providing immediate on-vehicle warning.
